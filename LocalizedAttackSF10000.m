...
clc;
close all;
%10000nodes at a time.with limitation 100%
...
rootNode = fix(rand*maxNode);
[LevelNodes, LevelTags] = CalSubNodesLA(net1, tags, maxNode, rootNode);
randID = LevelNodes;
...
save('P2Pnetwork-SF-LAPc10000once.mat', 'Pc1');
save('P2Pnetwork-SF-LAp10000once.mat', 'p1');